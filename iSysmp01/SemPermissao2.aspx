<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SemPermissao2.aspx.cs" Inherits="iSysmp01.SemPermissao2" %>
...
<legend><b><font color="#4B6C9E" face="Arial">Atenção - Segurança</font></b></legend>
    ...
    * * *
    ...
    &nbsp;* * *<br />
    <span class="style5">Usuário não tem permissão,</span><br 
        class="style5" />
    <span class="style5">&nbsp;para uso na, <asp:Label ID="lblHora1" runat="server" style="font-weight: 700"></asp:Label>
    &nbsp;caso</span><br 
        class="style5" />
