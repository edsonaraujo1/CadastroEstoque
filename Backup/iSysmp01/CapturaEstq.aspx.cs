...
namespace iSysmp01
{
    public partial class CapturaEstq : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // *****************************************************************************************
                string nodo_Form = "CapturaEsq";   // <<< **** Não esquecer de colocar o nome do Form **** >>>
                // *****************************************************************************************
            ...
            else
            {
                ...
                this.lblmsgerro.Text = "Menhum Produto Encontrado !!!";
            }
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            cod_info = Request.QueryString["inf"];

            Response.Redirect("WebEstoque1.aspx?codigo=" + cod_info);
                            ...
                            try
                            {
                                ...
                                using (MySqlConnection conexao = new MySqlConnection(strConx()))
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        query.CommandText = "UPDATE estoque SET foto ='" + path + FileUpload1.FileName + "', log = '" + log1 + "' WHERE codigo = " + cod_prod + "";
                                    ...
                                    {
                                        this.lblmsgerro.Text = "Não foi atualizar nome da Imagem !!!";
                                    }
                                }
                                //conexao.Close();
