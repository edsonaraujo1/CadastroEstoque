<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="GridUsuarios.aspx.cs" Inherits="iSysmp01.GridUsuarios" %>
...
<%Response.Flush(); //envia conteúdo para o browser%>
  ...
  <fieldset style="width:740px; flex-align:center;">
      <legend align="left"><b><font color="#4B6C9E" face="Arial">Lista Usuários</font></b></legend>
      ...
      <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
          ...
          onpageindexchanging="GridView1_PageIndexChanging" BorderStyle="None" CellPadding="4" ForeColor="#333333"  >
          <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
          <Columns>
              <asp:HyperLinkField DataNavigateUrlFields="Login" 
                  DataNavigateUrlFormatString="WebUsuarios.aspx?codigo={0}" 
                  DataTextField="login" HeaderText="Login" />
          </Columns>
